...
use OpportuniteBundle\Entity\categorie;
...
class categorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('OpportuniteBundle:categorie')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('OpportuniteBundle\Form\categorieType', $categorie);
    ...
    {
        $deleteForm = $this->createDeleteForm($categorie);
        $editForm = $this->createForm('OpportuniteBundle\Form\categorieType', $categorie);
